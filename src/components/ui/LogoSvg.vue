<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="10 37 236 179"
    enable-background="10 37 236 179"
    xml:space="preserve"
  >
    ...
    <g>
      <g>
        <g>
          <path
            fill="#42b883"
            d="M143.9,48.7L94,59.4l59.8,0.1c32.9,0,59.9,0,60-0.1c0.4-0.4-2.3-11.9-3.3-13.9c-1.3-2.7-5.1-6-7.9-7C198.2,37,196.4,37.3,143.9,48.7z"
          />
          <path
            fill="#42b883"
          ...
          <path
            fill="#42b883"
            d="M26.9,73.7c-3.9,0.9-8.1,2-9.1,2.6c-4.4,2.2-7.6,7.3-7.7,12.3c-0.1,2,2.9,16.5,11.1,54.6l11.2,51.9l0.2-59.3c0.2-55.2,0.3-59.4,1.1-61.4c0.4-1.1,0.8-2.1,0.7-2.2C34.2,72.2,30.9,72.9,26.9,73.7z"
          />
        </g>
      </g>
    </g>
